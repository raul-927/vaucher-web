...
<html lang="es">
	<head>
		...
		<?php 
			...
			include"pages/ContenidoDrenajeLinfatico.php";
	...
	<body>
		...
		<div class="container-fluid">
			<img alt="" height="50%" width="100%" src="images/Drenaje-Linfatico.jpg">
		</div>
			...
			<div class = "page-handler">
		    	...
		    	<div class ="row">
					<div class="col-xs-10 col-xs-offset-2 col1">
						<?php 
			       $contenidoPrincipal = new ContenidoDrenajeLinfatico();
