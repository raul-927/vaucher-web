...
<html lang="es">
	<head>
		...
		<?php 
			...
			include"pages/ContenidoTratamientoAntiAge.php";
	...
	<body>
		...
		<div class="row">
			<img alt="" height="25%" width="100%" src="images/Tratamiento_anti_age.jpg">
		</div>
			...
			<div class = "page-handler">
		    	...
		    	<div class ="row">
					<div class="col-xs-10 col-xs-offset-2 col1">
						<?php 
			       			$contenidoPrincipal = new ContenidoTratamientoAntiAge();
